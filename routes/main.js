...
router.get('/privacy-policy', (req, res) => {
  res.render('privacy-policy', {
    title: 'Privacy Policy | Garud Classes',
    description: 'Read the Garud Classes privacy policy to understand what information we collect, how we use it, and your choices regarding your personal data.',
    keywords: 'garud classes privacy policy, privacy policy garud classes, data protection, personal information policy',
    page: ''
  });
});
...
router.get('/sitemap.xml', async (req, res) => {
  try {
    ...
    let urls = [
      ...
      { loc: `${siteUrl}/privacy-policy`, priority: '0.5', changefreq: 'yearly' }
    ];
